...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Membership$ebnf$1", "symbols": []},
    {"name": "Membership$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "AssociationMember"]},
    {"name": "Membership$ebnf$1", "symbols": ["Membership$ebnf$1", "Membership$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Membership", "symbols": [{"literal":"|"}, "_", "AssociationMember", "Membership$ebnf$1"]},
    ...
    {"name": "Ordering", "symbols": ["Ordering$string$1", "_", "AssociationMember", "Ordering$ebnf$1"]},
