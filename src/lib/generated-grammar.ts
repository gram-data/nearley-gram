...
const grammar: Grammar = {
  Lexer: undefined,
  ParserRules: [
    {"name": "Gram$ebnf$1$subexpression$1", "symbols": ["Record", "_"]},
    {"name": "Gram$ebnf$1", "symbols": ["Gram$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "Gram$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "Gram$ebnf$2", "symbols": []},
    {"name": "Gram$ebnf$2$subexpression$1", "symbols": ["Pattern", "_"]},
    {"name": "Gram$ebnf$2", "symbols": ["Gram$ebnf$2", "Gram$ebnf$2$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Gram", "symbols": ["Gram$ebnf$1", "Gram$ebnf$2"], "postprocess": ([record, patterns]) => `(gram ${record ? record : ""} ${patterns.filter(nonNull).join(",")})`},
    ...
    {"name": "Pattern", "symbols": ["PatternElement", "Pattern$ebnf$1"], "postprocess": ([p1, ps]) => `(pattern ${p1})`},
    ...
    {"name": "PatternElement$subexpression$1", "symbols": ["Reference"]},
    {"name": "PatternElement", "symbols": ["PatternElement$ebnf$1", "PatternElement$subexpression$1"], "postprocess": ([anno, el]) => `${anno.filter(nonNull).join("@")}${el}?`},
    ...
    {"name": "Record", "symbols": [{"literal":"{"}, "_", "Property", "Record$ebnf$1", {"literal":"}"}], "postprocess": (d) => `(record ${(d.length > 2) ? d[2] : ""})`},
    {"name": "Property$subexpression$1", "symbols": ["Define"]},
    {"name": "Property$subexpression$1", "symbols": ["Declare"]},
    {"name": "Property", "symbols": ["Key", "_", "Property$subexpression$1", "_", "Value"], "postprocess": ([key, _1, binder, _2, value]) => `(property ${key} ${value})`},
    ...
    {"name": "Key$subexpression$1", "symbols": ["Integer"]},
    ...
    {"name": "Symbol", "symbols": [/[a-zA-Z_]/, "Symbol$ebnf$1"], "postprocess": (d) => `(symbol)`},
    ...
    {"name": "Integer", "symbols": ["Integer$ebnf$1", "Integer$ebnf$2"], "postprocess": (d) => `(integer)`},
    ...
    {"name": "Decimal$subexpression$1$ebnf$1", "symbols": [/[0-9]/]},
    {"name": "Decimal$subexpression$1$ebnf$1", "symbols": ["Decimal$subexpression$1$ebnf$1", /[0-9]/], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Decimal$subexpression$1", "symbols": [{"literal":"."}, "Decimal$subexpression$1$ebnf$1"]},
    {"name": "Decimal$ebnf$3$subexpression$1$ebnf$1", "symbols": [/[+-]/], "postprocess": id},
    {"name": "Decimal$ebnf$3$subexpression$1$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "Decimal$ebnf$3$subexpression$1$ebnf$2", "symbols": [/[0-9]/]},
    {"name": "Decimal$ebnf$3$subexpression$1$ebnf$2", "symbols": ["Decimal$ebnf$3$subexpression$1$ebnf$2", /[0-9]/], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Decimal$ebnf$3$subexpression$1", "symbols": [/[eE]/, "Decimal$ebnf$3$subexpression$1$ebnf$1", "Decimal$ebnf$3$subexpression$1$ebnf$2"]},
    {"name": "Decimal$ebnf$3", "symbols": ["Decimal$ebnf$3$subexpression$1"], "postprocess": id},
    {"name": "Decimal$ebnf$3", "symbols": [], "postprocess": () => null},
    {"name": "Decimal", "symbols": ["Decimal$ebnf$1", "Decimal$ebnf$2", "Decimal$subexpression$1", "Decimal$ebnf$3"], "postprocess": (d) => `(decimal)`},
    ...
    {"name": "Measurement", "symbols": ["NumericLiteral", "Symbol"]},
    {"name": "Percentage", "symbols": ["NumericLiteral", {"literal":"%"}]},
