...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Pattern$subexpression$1", "symbols": ["_", {"literal":","}, "_", "PatternElement"]},
    {"name": "Pattern", "symbols": ["PatternElement", "Pattern$subexpression$1"]},
    ...
    {"name": "Subject", "symbols": [{"literal":"["}, "_", "Attributes", "_", {"literal":"]"}]},
    ...
    {"name": "Property", "symbols": ["Symbol", "_", {"literal":":"}, "_", "Value"]},
