...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Association", "symbols": ["Membership"]},
    {"name": "Association", "symbols": ["Ordering"]},
    {"name": "Membership$ebnf$1$subexpression$1$ebnf$1", "symbols": ["Labels"], "postprocess": id},
    {"name": "Membership$ebnf$1$subexpression$1$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "Membership$ebnf$1$subexpression$1$ebnf$2", "symbols": ["Record"], "postprocess": id},
    {"name": "Membership$ebnf$1$subexpression$1$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "Membership$ebnf$1$subexpression$1", "symbols": ["Membership$ebnf$1$subexpression$1$ebnf$1", "Membership$ebnf$1$subexpression$1$ebnf$2", "_", {"literal":"|"}]},
    {"name": "Membership$ebnf$1", "symbols": ["Membership$ebnf$1$subexpression$1"], "postprocess": id},
    {"name": "Membership$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "Membership$ebnf$2", "symbols": []},
    {"name": "Membership$ebnf$2$subexpression$1", "symbols": ["_", {"literal":","}, "_", "AssociationMember"]},
    {"name": "Membership$ebnf$2", "symbols": ["Membership$ebnf$2", "Membership$ebnf$2$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Membership", "symbols": [{"literal":"|"}, "Membership$ebnf$1", "_", "AssociationMember", "Membership$ebnf$2"]},
    {"name": "Ordering$subexpression$1$string$1", "symbols": [{"literal":"-"}, {"literal":">"}], "postprocess": (d) => d.join('')},
    {"name": "Ordering$subexpression$1", "symbols": ["Ordering$subexpression$1$string$1"]},
    {"name": "Ordering$subexpression$1$string$2", "symbols": [{"literal":"-"}, {"literal":"["}], "postprocess": (d) => d.join('')},
    {"name": "Ordering$subexpression$1$ebnf$1", "symbols": ["Labels"], "postprocess": id},
    {"name": "Ordering$subexpression$1$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "Ordering$subexpression$1$ebnf$2", "symbols": ["Record"], "postprocess": id},
    {"name": "Ordering$subexpression$1$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "Ordering$subexpression$1$string$3", "symbols": [{"literal":"]"}, {"literal":"-"}, {"literal":">"}], "postprocess": (d) => d.join('')},
    {"name": "Ordering$subexpression$1", "symbols": ["Ordering$subexpression$1$string$2", "Ordering$subexpression$1$ebnf$1", "Ordering$subexpression$1$ebnf$2", "Ordering$subexpression$1$string$3"]},
    {"name": "Ordering$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "AssociationMember"]},
    {"name": "Ordering$ebnf$1", "symbols": ["Ordering$ebnf$1$subexpression$1"]},
    {"name": "Ordering$ebnf$1$subexpression$2", "symbols": ["_", {"literal":","}, "_", "AssociationMember"]},
    {"name": "Ordering$ebnf$1", "symbols": ["Ordering$ebnf$1", "Ordering$ebnf$1$subexpression$2"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Ordering", "symbols": ["Ordering$subexpression$1", "_", "AssociationMember", "Ordering$ebnf$1"]},
