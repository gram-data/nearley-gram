...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Association", "symbols": ["Associator", "_", "Members"]},
    {"name": "Associator", "symbols": ["Description"]},
    {"name": "Associator", "symbols": ["Ordering"]},
    {"name": "Associator", "symbols": ["Containment"]},
    {"name": "Members$ebnf$1", "symbols": []},
    {"name": "Members$ebnf$1$subexpression$1", "symbols": ["_", {"literal":","}, "_", "AssociationMember"]},
    {"name": "Members$ebnf$1", "symbols": ["Members$ebnf$1", "Members$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "Members", "symbols": ["AssociationMember", "Members$ebnf$1"]},
    ...
    {"name": "Description", "symbols": [{"literal":"|"}]},
    {"name": "Ordering", "symbols": ["PlainArrow"]},
